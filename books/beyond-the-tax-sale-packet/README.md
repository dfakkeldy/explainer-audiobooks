...
- Edition: `2026-public-epub`
- Publication status: `public-epub`
...
The EPUB embeds the selected portrait cover byte-for-byte. The square companion
and paired receipt are preserved now so a later audiobook can keep the same
visual identity; this package does not contain or claim a finished M4B.
...
- `m4b-cover.png` — selected square companion for the future audiobook
